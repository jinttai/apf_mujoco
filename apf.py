...
def apf_control_value(qpos, qvel, robot, rkd, pcd):
...
def main():
    ...
    original_model_path = os.path.join(current_dir, 'model_cjt', 'spacerobot_cjt.xml')
    ...
    with mujoco.viewer.launch_passive(model, data) as viewer:
        while not rospy.is_shutdown():
            ...
            control = 0.5 * (qvel[6:12] - apf_control_value(qpos, qvel, robot_spart, rkd, pcd).flatten())
